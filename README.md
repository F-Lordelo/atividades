...
**Descrição:** Vamos solicitar como entrada dois números e depois realizar uma operação simples entre eles.
...
- ✅ Introdução ao conceito de operador de módulo (%) para verificar paridade
- ✅ Exploração do uso de IA (Github Copilot) para otimizar a estrutura do código
